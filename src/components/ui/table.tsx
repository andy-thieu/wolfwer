...
function TableBody({ className, ...props }: React.ComponentProps<"tbody">) {
  return (
    <tbody
      ...
      className={cn("rounded-xs [&_tr:last-child]:border-0", className)}
      {...props}
    />
  );
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-border text-main-foreground font-base data-[state=selected]:bg-secondary-background data-[state=selected]:text-main-foreground border-b-2 bg-white transition-colors",
        className,
      )}
      {...props}
    />
